...
- **Jazyk a jazyková komunikace** - *Český jazyk a literatura* - Jazyková výchova - 2. období
  - Očekávané výstupy
...
- **Jazyk a jazyková komunikace** - *Český jazyk a literatura* - Literární výchova - 2. období
  - Očekávané výstupy
...
- **Matematika a její aplikace** - Číslo a početní operace - 2. období
  - Očekávané výstupy
...
- **Matematika a její aplikace** - Závislosti, vztahy a práce s daty - 2. období
  - Očekávané výstupy
    - M-5-2-01 vyhledává, sbírá a třídí data
    - M-5-2-02 čte a sestavuje jednoduché tabulky a diagramy

- **Matematika a její aplikace** - Geometrie v rovině a prostoru - 2. období
  - Očekávané výstupy
...
- **Jazyk a jazyková komunikace** - *Český jazyk a literatura* - Komunikační a slohová výchova
  - Učivo
    - čtení – praktické (pozorné, přiměřeně rychlé, znalost orientačních prvků v textu), věcné (studijní, čtení jako zdroj informací, vyhledávací), kritické (analytické, hodnoticí), prožitkové
...
- **Jazyk a jazyková komunikace** - *Český jazyk a literatura* - Jazyková výchova
  - Učivo
    - zvuková podoba jazyka – zásady spisovné výslovnosti, modulace souvislé řeči (přízvuk slovní a větný), intonace, členění souvislé řeči (pauzy, frázování)
...
- **Matematika a její aplikace** - Geometrie v rovině a prostoru
  - Učivo
...
- **Matematika a její aplikace** - Nestandardní aplikační úlohy a problémy
  - Učivo
...
- **Člověk a společnost** - *Dějepis* - Moderní doba
  - Učivo
    ...
    - mezinárodněpolitická a hospodářská situace ve 20. a 30. letech; totalitní systémy – komunismus, fašismus, nacismus – důsledky pro Československo a svět
